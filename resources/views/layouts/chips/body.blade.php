        ...
        <div class="card shadow border-start-primary py-2">
            <div class="card-body">
                <div class="row align-items-center no-gutters">
                    <div class="col me-2">
                        <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Uploaded Samples</span>
                        </div>
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <div class="card shadow border-start-success py-2">
            <div class="card-body">
                <div class="row align-items-center no-gutters">
                    <div class="col me-2">
                        <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Analyzed Samples</span>
                        </div>
                        <div class="text-dark fw-bold h5 mb-0"><span>ph</span></div>
                    </div>
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <div class="card shadow border-start-warning py-2">
            <div class="card-body">
                <div class="row align-items-center no-gutters">
                    <div class="col me-2">
                        <div class="text-uppercase text-warning fw-bold text-xs mb-1"><span>Queued Analysis</span>
                        </div>
                        <div class="text-dark fw-bold h5 mb-0"><span>ph</span></div>
                    </div>
    ...
    <div class="col-lg-7 col-xl-8">
        <div class="card shadow mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="text-primary fw-bold m-0">Analyzed Samples</h6>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="text-center small mt-4"><span class="me-2"><i
                            class="fas fa-circle text-primary"></i>&nbsp;Static</span><span class="me-2"><i
                            class="fas fa-circle text-success"></i>&nbsp;Dynamic</span><span class="me-2"><i
                            class="fas fa-circle text-info"></i>&nbsp;AI</span></div>
            </div>
        </div>
    </div>
</div>
